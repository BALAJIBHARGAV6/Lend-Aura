module aura_lend::auction_house {
    ...
    public entry fun start_auction(
        ...
        // Emit event
        events::emit_auction_started(auction_id, nft_id, lender, 0, now, now + (duration_hours * 60 * 60));
    }
    ...
    public entry fun place_bid(
        ...
        // Emit event
        events::emit_bid_placed(auction_id, bidder_addr, bid_amount, timestamp::now_seconds());
    }
    ...
    public entry fun end_auction(
        ...
        // We'll omit this event for now since it's not the right signature
    }
    ...
    public entry fun settle_auction(
        ...
        // Emit event
        events::emit_auction_settled(auction_id, auction.highest_bidder, auction.current_bid, auction.nft_id, timestamp::now_seconds());
    }
