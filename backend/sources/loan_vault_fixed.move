module aura_lend::loan_vault {
    ...
    public entry fun create_loan_request(
        ...
        // Emit event
        events::emit_loan_requested(loan_id, borrower_addr, amount_requested, collateral_nft_id);
    }
    ...
    public entry fun fund_loan(
        ...
        // Emit event
        events::emit_loan_funded(loan_id, loan.borrower, lender_addr, amount);
    }
    ...
    public entry fun repay_loan(
        ...
        // Emit event
        events::emit_loan_repaid(loan_id, borrower_addr, loan.lender, repayment_amount);
    }
    ...
    public entry fun mark_loan_defaulted(
        ...
        // Emit event
        events::emit_loan_defaulted(loan_id, loan.borrower, loan.lender, loan.collateral_nft_id);
    }
