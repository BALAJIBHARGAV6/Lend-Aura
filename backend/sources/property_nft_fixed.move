module aura_lend::property_nft {
    ...
    public entry fun mint_property_nft(
        ...
        // Emit event
        events::emit_property_minted(property_id, owner_addr, metadata_uri);
    }
    ...
    public entry fun attest_property(
        ...
        // Emit event
        events::emit_property_attested(property_id, nft_owner, attestor_addr);
    }
    ...
    public entry fun transfer_property(
        ...
        let (_, mut nft) = simple_map::remove(&mut current_collection.nfts, &property_id);
        ...
        simple_map::add(&mut new_collection.nfts, property_id, nft);

        // Emit event
        events::emit_property_transferred(property_id, current_owner_addr, new_owner_addr);
    }
